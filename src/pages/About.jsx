    ...
    <main className="about-page">
      ...
      <section className="about-content">
        <div className="about-text">
          ...
          <p>I volunteered and hosted a show at 101.9 CFUV (Victoria's campus radio station), helped organise gigs and open mic nights with the Live Music Club, played in a couple local bands, and got involved in many creative projects.{' '}
